...
firmware: CFLAGS += -D__HEAP_SIZE=8192
firmware: CFLAGS += -D__STACK_SIZE=8192
firmware: ASMFLAGS += -D__HEAP_SIZE=8192
firmware: ASMFLAGS += -D__STACK_SIZE=8192
...
flash: default
	...
	nrfjprog -f nrf52 --program $(OUTPUT_DIRECTORY)/firmware.hex --sectorerase
